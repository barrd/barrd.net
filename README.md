...
![barrd.net logo](dist/img/barrd-net-social-featured.png "Site default image")

## You are welcome to view, clone or download this code
...
- Simple CSS print styles to remove unneeded elememts like images and leave links.
